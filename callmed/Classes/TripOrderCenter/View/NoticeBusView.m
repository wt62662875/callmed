...
- (void) initTimer
{
    ...
    dispatch_source_set_event_handler(_timer, ^{
        ...
        lastTimer--;
        if (!isCanceled) {
            [_buttonSubmit setTitle:[NSString stringWithFormat:@"接单(%@)",[NSString stringWithFormat:@"%ld",(long)lastTimer]] forState:UIControlStateNormal];
        }
